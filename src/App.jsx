      ...
      <section className="hero">
        <div className="hero-row">
          <aside className="hero-card" aria-label="Profile image tile">
            <img src="${import.meta.env.BASE_URL}Shobhit.jpeg" alt="Portrait of Shobhit Awasthi" />
          </aside>
...
<br /><br />
  ...
  <article className="panel">
    <h2>About me</h2>
    <p>
      I’m Shobhit Awasthi, a BCA graduate from IIPS DAVV Indore and currently pursuing my MCA, with a strong passion for building technology that is practical, dependable, and meaningful. I was born in Badnawar, and my journey through Kashyap Vidhyapeeth, Sanmati Higher Secondary, Gyanodaya Vidhyalaya, and later I.I.P.S. D.A.V.V. Indore has shaped the way I approach learning and growth. It taught me to value consistency, curiosity, and the discipline required to keep improving every day.
      <br /><br />
